...
import com.chengchao.CommonsenseGame.service.SecurityUserDetailService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.authorizeRequests(authorizeRequests ->
      authorizeRequests
          .antMatchers("/", "/login", "/user/signup", "/test/**", "/kb/**", "/result/**", "/images/**","/members/**","/group/**","/game/**", "/video/**").permitAll()
